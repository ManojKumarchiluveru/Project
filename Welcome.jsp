  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/5.jpg" alt="Uncharted 4" width="200" height="550">
      ...
      <div class="item">
        <img src="resources/images/6.jpg" alt="Angry Birds" width="200" height="550">
        <div class="carousel-caption">
          <h3>Angry Birds</h3>
          <p>Angry Birds</p>
        </div>
      ...
      <div class="item">
        <img src="resources/images/7.jpg" alt="prince Of Pursia" width="200" height="550">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="resources/images/8.jpg" alt="MetalGearRising" width="200" height="550">
        <div class="carousel-caption">
          <h3>MGR</h3>
          <p> MGR</p>
        </div>
...
<div class="img">
  <a target="_blank" href="img_lights.jpg">
    <img src="resources/images/9.jpg" alt="Northern Lights" width="600" height="400">
  </a>
  <div class="desc">Add a description of the image here</div>
</div>
